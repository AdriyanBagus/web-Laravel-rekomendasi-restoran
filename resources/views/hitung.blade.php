                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Restoran</h3>
                            <p class="text-subtitle text-muted">Melakukan proses penghitungan</p>
                        </div>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$C1min['restorans'] / $item->Harga}}</td>
                                                    <td>{{$item->Lokasi / $C2max['restorans']}}</td>
                                                    <td>{{$item->Menu / $C3max['restorans']}}</td>
                                                    <td>{{$C4min['restorans'] / $item->Pelayanan}}</td>
                                                    <td>{{$item->Jarak / $C5max['restorans']}}</td>
                                ...
                                <div class="card-content mt-3">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th class="ps-3">Restoran Terbaik</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td class="ps-3">{{$item->nama }}</td>
                                                    <td> 
                                                    {{(($item->Harga/$C1min['restorans'])*$widget1['kriterias'])+
                                                    (($item->Lokasi/$C2min['restorans'])*$widget2['kriterias'])+
                                                    (($C3min['restorans']/$item->Menu)*$widget3['kriterias'])+
                                                    (($C4min['restorans']/$item->Pelayanan)*$widget4['kriterias'])+
                                                    (($C5min['restorans']/$item->Jarak)*$widget5['kriterias'])}}
                                                    </td>
                                                </tr>
