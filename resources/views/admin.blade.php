...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="{{ url('/admin') }}"><img src="{{ url('assets/images/logo/logo.svg') }}
                " alt="Logo" srcset=""></a>
            </div>
...
<div class="page-heading">
    <h3>Welcome Admin! Adriyan Bagus Krisnayandhi</h3>
</div>
            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            <h5 class="font-bold">John Beck</h5>
            ...
            <div class="card">
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1">Adam Warlock</h5>
                            <h6 class="text-muted mb-0">@adam123</h6>
                        </div>
                    </div>
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
